/**
 * Squarespace Embed Code Generator
 * 
 * Generates Squarespace-specific embed code for the Google Reviews Widget
 */

import { type EmbedOptions } from './html-embed';

/**
 * Generate Squarespace embed code
 */
export function generateSquarespaceEmbed(options: EmbedOptions): string {
  const {
    widgetId,
    apiKey,
    widgetConfig,
